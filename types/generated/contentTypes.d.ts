...
export interface ApiAmenityAmenity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amenityId: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    createdAmenityAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    pgs: Schema.Attribute.Relation<'manyToMany', 'api::pg.pg'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAmenityAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiChatbotChatbot extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    chatType: Schema.Attribute.UID;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    createdChatAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::chatbot.chatbot'
    ...
    >;
    users_permissions_user2: Schema.Attribute.Relation<
      'oneToOne',
      'plugin::users-permissions.user'
    >;
  };
...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::offer.offer'> &
      Schema.Attribute.Private;
    offerFrom: Schema.Attribute.String;
    offerId: Schema.Attribute.UID & Schema.Attribute.Required;
    ...
    validUpto: Schema.Attribute.DateTime & Schema.Attribute.Required;
  };
}
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    approvedBy: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    paymentDetailscreatedAt: Schema.Attribute.DateTime;
    paymentMode: Schema.Attribute.Enumeration<
      ['Cash', 'Upi', 'NEFT', 'Check']
    > &
      Schema.Attribute.Required;
    paymentOf: Schema.Attribute.Enumeration<
      [
        'January',
        'February',
        'March',
    ...
    pgId: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPgPg extends Struct.CollectionTypeSchema {
  collectionName: 'pgs';
  info: {
    description: '';
    displayName: 'PG';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentation: Schema.Attribute.Enumeration<['Active', 'Inactive']>;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pg.pg'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.String & Schema.Attribute.Required;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    ownerName: Schema.Attribute.String & Schema.Attribute.Required;
    pgCreatedAt: Schema.Attribute.DateTime;
    pgId: Schema.Attribute.UID & Schema.Attribute.Required;
    pgUpdatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    room: Schema.Attribute.Component<'pg-details.rooms', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiReminderReminder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['Rent', 'Electricity']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    reminderId: Schema.Attribute.UID;
    remindTo: Schema.Attribute.String;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVerificationVerification
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentImage: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    documentType: Schema.Attribute.Enumeration<
      ['Aadhar', 'Passport', 'Driving License', 'Pan Card', 'Other']
    > &
      Schema.Attribute.Required;
    ...
    verificationFor: Schema.Attribute.Enumeration<
      ['User', 'PG Owner', 'Management']
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    reminder: Schema.Attribute.Relation<'manyToOne', 'api::reminder.reminder'>;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
